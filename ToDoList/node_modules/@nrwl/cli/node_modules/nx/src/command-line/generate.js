...
function generate(cwd, args) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const workspaceConfiguration = (0, project_graph_1.readProjectsConfigurationFromProjectGraph)(projectGraph);
        const isVerbose = args['verbose'];
        return (0, params_1.handleErrors)(isVerbose, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const combinedOpts = yield (0, params_1.combineOptionsForGenerator)(opts.generatorOptions, opts.collectionName, normalizedGeneratorName, workspaceConfiguration, schema, opts.interactive, ws.calculateDefaultProjectName(cwd, workspaceConfiguration), ws.relativeCwd(cwd), isVerbose);
            if (ws.isNxGenerator(opts.collectionName, normalizedGeneratorName)) {
